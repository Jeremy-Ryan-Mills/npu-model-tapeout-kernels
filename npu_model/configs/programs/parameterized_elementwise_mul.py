...
Tiles both inputs and output into 32×32 bf16 blocks stored row-major in
DRAM (2048 B per tile).  The inner loop uses vmul.bf16.
...
class ParameterizedElementwiseMul32x32Program(Program):
    """Elementwise multiply on a single 32×32 bf16 tile."""
...
class ParameterizedElementwiseMul64x64Program(Program):
    """Elementwise multiply on a 64×64 bf16 tensor (2×2 tiles)."""
...
class ParameterizedElementwiseMul32x64Program(Program):
    """Elementwise multiply on a 32×64 bf16 tensor (1×2 tiles)."""
